...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str, default='resized', help='directory for resized images')
    parser.add_argument('--caption_path', type=str, default='captions.csv', help='path for train annotation json file')
    parser.add_argument('--log_step', type=int , default=10, help='step size for prining log info')
    parser.add_argument('--save_step', type=int , default=24, help='step size for saving trained models')
